...
export const roadmap = [
  {
    id: "0",
    title: "ReactX",
    text: "Join our three-day React.js Bootcamp, where you'll master the latest in front-end development and dive into an empowering hackathon experience.",
    date: "JUNE 2024",
    status: "done",
    imageUrl: roadmap1,
    colorful: true,
  ...
  {
    id: "1",
    title: "Cloud Computing using Amazon Web Services",
    text: "Unlock the potential of Amazon Web Services to master Cloud Computing and DEVOPS, propelling you to the forefront of Deployment, culminating in an exhilarating hackathon experience.",
    date: "JUNE 2024",
    status: "progress",
    imageUrl: roadmap2,
  },
  {
    id: "2",
    title: "Hands-on PyAI",
    text: "Master the practical experience building AI models using Python in this interactive workshop",
    date: "JUNE 2024",
    status: "done",
    imageUrl: roadmap3,
  },
...
export const collabContent = [
  ...
  {
    id: "1",
    title: "Front-End Web & Cloud computing Excellence",
  },
  {
    id: "2",
