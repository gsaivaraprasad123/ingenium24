...
export const benefits = [
  ...
  // {
  //   id: "1",
  //   title: "Cloud Computing using Azure",
  //   text: "Unlock the potential of Azure to master Cloud Computing and DEVOPS, propelling you to the forefront of Deployment, culminating in an exhilarating hackathon experience.",
